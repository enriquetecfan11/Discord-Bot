    ...
    run: async (client, message, args) => {
        ...
        try{
            ...
            const embed = new discord.EmbedBuilder()
                ...
                .setFooter({ text: `Requested by ${message.author.username} | Today at ${timezone.tz("Europe/Madrid").format("HH:mma") + " "}`, iconURL: message.author.displayAvatarURL({ 
                        dynamic: true 
                    }) 
                })
